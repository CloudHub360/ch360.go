...
func anExtractionResultWith2Fields() *results.ExtractionResult {
	var extractionResult results.ExtractionResult

	json.Unmarshal([]byte(anExtractionResponseJsonWith2Fields), &extractionResult)
...
var anExtractionResponseJsonWith2Fields = `{
  "field_results": [
    {
      "field_name": "Amount",
      "rejected": false,
